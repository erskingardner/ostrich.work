...
<div class="flex flex-col gap-1 w-full">
    ...
    <div id="{fieldName}PreviewContainer" class="markdownContent w-full border border-zinc-400 dark:border-zinc-600 bg-transparent px-2 py-1 text-base">{@html preview}</div>
</div>